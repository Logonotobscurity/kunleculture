  ...
  return (
    <section className="w-full py-16 md:py-24">
      <div className="container mx-auto px-4 md:px-6">
        <div className="bg-secondary text-secondary-foreground rounded-2xl p-8 md:p-16 flex flex-col lg:flex-row items-center justify-between gap-8">
            <div className="text-center lg:text-left">
                <h2 className="text-3xl md:text-4xl font-sans font-semibold">Join the Kunle Circle</h2>
                <p className="mt-2 text-lg text-secondary-foreground/80 max-w-xl">
            ...
            <form className="w-full max-w-md flex flex-col sm:flex-row gap-4">
                ...
                />
                <Button type="submit" size="lg" className="h-12 bg-white text-secondary hover:bg-stone-200 rounded-full shadow-large">
                    Subscribe
                </Button>
            </form>
        </div>
